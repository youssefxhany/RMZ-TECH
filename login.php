<?php
    ...
    if(isset($_POST['login_submit'])){
     ...
     if(mysqli_num_rows($result) == 0){
       ...
       $_SESSION['phone_number']= $result_list['phoneNumber'];
       $_SESSION['Billing_address']= $result_list['billingAddress'];
       $_SESSION['favorite_category']= $result_list['favoriteCategory'];
       $_SESSION['birth_date']= $result_list['BirthDate'];
